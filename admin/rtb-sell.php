...
$current_timestamp = '2025-06-25 20:50:41'; // Current UTC time
...
if ($_POST && isset($_POST['action'])) {
    try {
        if ($_POST['action'] === 'toggle_status' && isset($_POST['campaign_id'])) {
            ...
            $stmt = $pdo->prepare("UPDATE campaigns SET status = ? WHERE id = ? AND type = 'rtb'");
            ...
            $stmt = $pdo->prepare("DELETE FROM campaigns WHERE id = ? AND type = 'rtb'");
...
// Ad formats available for RTB campaigns
$ad_formats = [
...
// Get active campaigns - using ad_formats if available, fallback to banner_sizes for compatibility
$campaigns = $pdo->query("
...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-1">
                    <i class="fas fa-exchange-alt text-primary"></i> RTB Campaigns
                </h1>
                <p class="text-muted mb-0">Manage Real-Time Bidding campaigns</p>
            </div>
...
<div class="card mb-4 shadow-sm">
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0"><i class="fas fa-plus me-2"></i>Create RTB Campaign</h5>
    </div>
            ...
            <form method="POST">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="form-text">Optional: External RTB endpoint for bid requests</div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle me-2"></i>Select the ad formats you want to support in this RTB campaign. 
                ...
                <div class="d-grid">
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="fas fa-save me-2"></i>Create RTB Campaign
                    </button>
                </div>
            </form>
        </div>
...
<div class="card shadow-sm">
    <div class="card-header bg-white d-flex justify-content-between align-items-center">
        <h5 class="mb-0 text-primary">
            <i class="fas fa-list me-2"></i>RTB Campaigns
        </h5>
        <span class="badge bg-primary fs-6"><?php echo count($campaigns); ?> Campaigns</span>
    </div>
    <div class="card-body">
        <?php if (empty($campaigns)): ?>
            <div class="text-center py-5">
                <i class="fas fa-exchange-alt fa-4x text-muted mb-4"></i>
                <h4 class="text-muted">No RTB campaigns created yet</h4>
                <p class="text-muted mb-4">Create your first RTB campaign to start managing real-time bidding ads.</p>
                <button class="btn btn-primary btn-lg" type="button" data-bs-toggle="collapse" data-bs-target="#createCampaignForm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="small">
                                    <?php if ($campaign['daily_budget']): ?>
                                        <div><i class="fas fa-calendar-day me-1 text-primary"></i><?php echo formatCurrency($campaign['daily_budget']); ?>/day</div>
                                    <?php endif; ?>
                                    <?php if ($campaign['total_budget']): ?>
                                        <div><i class="fas fa-wallet me-1 text-success"></i><?php echo formatCurrency($campaign['total_budget']); ?> total</div>
                                    <?php endif; ?>
                            ...
                            <td class="text-center">
                                <div class="small">
                                    <div class="fw-bold text-primary"><?php echo $campaign['creative_count']; ?></div>
                                    <div class="text-muted">total</div>
                                    <div class="text-success fw-medium"><?php echo $campaign['active_creatives']; ?> active</div>
                                    <a href="creative.php?campaign_id=<?php echo $campaign['id']; ?>" 
                            ...
                            <td>
                                <div class="small">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <strong class="text-primary"><?php echo formatNumber($campaign['impressions'] ?? 0); ?></strong>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <span>Clicks:</span>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <span>Spent:</span>
                                        <strong class="text-success"><?php echo formatCurrency($campaign['revenue'] ?? 0); ?></strong>
                                    </div>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm d-flex" role="group">
                                    ...
                                    <a href="statistics.php?campaign_id=<?php echo $campaign['id']; ?>" 
                                       class="btn btn-outline-success" data-bs-toggle="tooltip" title="View Statistics">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.btn-edit').forEach(function(btn) {
        btn.addEventListener('click', function() {
            ...
            window.location.href = 'edit-campaign.php?id=' + campaignId + '&type=rtb';
        });
    });
